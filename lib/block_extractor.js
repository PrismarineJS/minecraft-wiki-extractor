...
function writeAllBlocks(file,date,cb)
{
  async.waterfall([
      function(cb){id_table_parser.parseDataValues("Data_values/Block_IDs",date,cb)},
...
{
  wikiTextParser.getFixedArticle("Breaking",date,function(err,data){
    var sectionObject=wikiTextParser.pageToSectionObject(data);
...
{
  wikiTextParser.getFixedArticle("Module:Hardness_values",date,function(err,data){
    var sectionObject=wikiTextParser.pageToSectionObject(data);
